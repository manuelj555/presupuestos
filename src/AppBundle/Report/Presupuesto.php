...
class Presupuesto
{
    ...
    public static function excel(Presupuestos $presupuesto)
    {
        ...
        $styleHeaderArray = array(
            ...
            'fill' => array(
                'type' => PHPExcel_Style_Alignment2::FILL_SOLID,
        ...
        $styleBordeExterno['borders']['top'] = $styleBordeExterno['borders']['bottom'] = $styleBordeExterno['borders']['left'] = $styleBordeExterno['borders']['right'] = array(
